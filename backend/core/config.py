...
class Settings:
    ...
    history_max_events: int = int(os.getenv("SAT_HISTORY_MAX_EVENTS", "1000"))
    conjunction_history_file: str = os.getenv(
        "SAT_CONJUNCTION_HISTORY_FILE",
        str(PROJECT_ROOT / "cache" / "conjunction_history.json"),
    )
